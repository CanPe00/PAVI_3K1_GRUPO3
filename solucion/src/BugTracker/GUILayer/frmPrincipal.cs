...
namespace BugTracker.GUILayer
{
    public partial class frmPrincipal : Form
    {
        ...
        private void listaDeActividadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ListadoActividades listado = new ListadoActividades();
            listado.ShowDialog();
        }

        private void cursosFinalizadosPorFechaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmGeneradorReporteFechaFinCurso frm = new frmGeneradorReporteFechaFinCurso();
            frm.ShowDialog();
        }
    }
